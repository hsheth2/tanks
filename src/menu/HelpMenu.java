...
public class HelpMenu extends Menu {
	...
	public HelpMenu(GameState state, JPanel canvas) {
		...
		pages = new Page[] { new Page("Controls", new String[] { "WASD - Move", "Click - Shoot", "Space - Lay mine" }, 0, 300, this),
				...
				new Page("Walls", new String[] { "Walls are gray. You can't shoot through", "or move through a wall." }, 0, 300, this),
				new Page("Holes", new String[] { "Holes are black. You can shoot through", "a hole, but you can't move over it." }, 0, 300, this),
